...
class SettingsLanguageBottomSheetLanguageRow extends StatefulWidget {
  ...
  @override
  State<SettingsLanguageBottomSheetLanguageRow> createState() => _SettingsLanguageBottomSheetLanguageRowState();
}

class _SettingsLanguageBottomSheetLanguageRowState extends State<SettingsLanguageBottomSheetLanguageRow> {
  @override
        ...
        children: [
          ...
          DropdownButtonHideUnderline(
            child: DropdownButton<Language>(
              ...
              dropdownColor: BaseController.themeController.isDark.value ? kDarkFieldColor : kLightFieldColor,
              elevation: 16,
              ...
              items: languageList.map<DropdownMenuItem<Language>>((Language lang) {
