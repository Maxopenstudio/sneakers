                                  ...
                                  Container(
                                      ...
                                      child: Container(
                                          ...
                                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                            ...
                                            Container(width: getHorizontalSize(276), margin: getMargin( right: 111), child: Text("msg_4517_washington".tr, maxLines: 2, textAlign: TextAlign.left, style: AppStyle.txtBody))
                                          ]))),
