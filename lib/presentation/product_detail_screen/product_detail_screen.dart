...
class ProductDetailScreen extends GetWidget<ProductDetailController> {
            ...
            appBar: CustomAppBar(
                ...
                actions: [
                  Obx(() => AppbarImage(
                        height: getSize(24),
                        width: getSize(24),
                        svgPath: productsController
                                .isProductInFavorites(product.productId)
                                        ...
                                        GetBuilder<ProductDetailController>(
                                          ...
                                          builder: (controller) => Container(
                                            ...
                                            child: ListView.separated(
                                                ...
                                                itemCount: product.options!
                                                    .first.optionValue.length),
                                          ),
                                        ),
                                        Container(
                ...
                GetBuilder<HomeScreenContainerController>(
                  ...
                  builder: (controller) => CustomButton(
                      onTap: () async {
                       ...
                       await cartController.addProductInCart(
                            product.productId,
                            productDetailController.quantity,
                            product.options!.first.productOptionId,
                            product.options!.first.optionValue[productDetailController.sizeIndex.value].productOptionValueId);
                      },
  ...
  Future<void> favorite() async {
    ...
    productsController.favoriteProducts.value =
        (await productsController.apiClient.getFavoriteProducts())
            .map((product) => productsController.getProductById(product))
            .toList();
