...
class BaseController {
  ...
  static final NavigationController navigationController = Get.find<NavigationController>();
  ...
  static final CategoriesController categoriesController = Get.find<CategoriesController>();
  static final SearchShoeController searchShoeController = Get.find<SearchShoeController>();
  ...
  static final MessageController messageController = Get.find<MessageController>();
  static final SettingsController settingsController = Get.find<SettingsController>();
  static final TrackLocationController trackLocationController = Get.find<TrackLocationController>();
  static final ProductsController productsController = Get.find<ProductsController>();
}
